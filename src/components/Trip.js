...
const mapStyle = "mapbox://styles/sojinsojin/clxo9mhhh00gh01rnfffs0gmq";

//  자신의 mapbox api key 입력
// const MAPBOX_TOKEN = `mapbox api key`;
const MAPBOX_TOKEN = `pk.eyJ1Ijoic29qaW5zb2ppbiIsImEiOiJjbHgxZmtvZXkwNXpmMmxvbTFlbmx2NnpsIn0.ouUDJmfkswVTSqErRPX2oA`;
